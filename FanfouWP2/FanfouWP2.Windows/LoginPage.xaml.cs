...
namespace FanfouWP2
{
    ...
    public sealed partial class LoginPage : Page
    {
        ...
        {
            Utils.ToastShow.ShowToast("登陆失败", "登录用户名或密码有误");
        }
        ...
        {
            if (this.username.Text.Count() != 0 && this.password.Password.Count() != 0)
                FanfouAPI.FanfouAPI.Instance.Login(this.username.Text, this.password.Password);
        }
    }
}
