...
namespace FanfouWP2
{
    public sealed partial class ImageUserPage : Page
    {
        ...
        void Instance_PhotosUserTimelineFailed(object sender, FailedEventArgs e)
        {
        }

        void Instance_PhotosUserTimelineSuccess(object sender, EventArgs e)
        {
        ...
        private void NavigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            title.Text = this.user.screen_name + "的图片";
