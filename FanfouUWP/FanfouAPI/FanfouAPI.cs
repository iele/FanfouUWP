...
namespace FanfouUWP.FanfouAPI
{
    public class FanfouAPI
    {
        ...
        public async Task<User> AccountUpdateProfile(string url = "", string location = "", string description = "",
            string name = "", string email = "")
        {
            ...
            User result = await client.PostRequestObject<User>(FanfouConsts.ACCOUNT_UPDATE_PROFILE, parameters);
            result.auth = SettingStorage.Instance.currentUser.auth;
        ...
        public async Task<User> FriendshipCreate(string id)
        {
            RestClient client = GetClient();
            var parameters = new Parameters();
            parameters.Add("id", id);
            User result =
               await client.PostRequestObject<User>(FanfouConsts.FRIENDSHIPS_CREATE, parameters);
            return result;
        }

        public async Task<User> FriendshipDestroy(string id)
        {
            RestClient client = GetClient();
            var parameters = new Parameters();
            parameters.Add("id", id);
            User result =
               await client.PostRequestObject<User>(FanfouConsts.FRIENDSHIPS_DESTROY, parameters);
            return result;
        }
        ...
        #region blocks
        public async Task<List<User>> BlocksBlocking(int count = 60, int page = 1)
        {
            RestClient client = GetClient();
            var parameters = new Parameters();
            if (page > 0)
            ...
            parameters.Add("count", count.ToString());
            List<User> result =
                await client.GetRequestObjectCollection<User>(FanfouConsts.BLOCKS_BLOCKING, parameters);
            return result;
        }

        public async Task<User> BlockCreate(string id)
        {
            RestClient client = GetClient();
            var parameters = new Parameters();
            parameters.Add("id", id);
            User result =
               await client.PostRequestObject<User>(FanfouConsts.BLOCKS_CREATE, parameters);
            return result;
        }

        public async Task<User> BlockDestroy(string id)
        {
            RestClient client = GetClient();
            var parameters = new Parameters();
            parameters.Add("id", id);
            User result =
               await client.PostRequestObject<User>(FanfouConsts.BLOCKS_DESTROY, parameters);
            return result;
        }

        public async Task<bool> BlockExists(string id)
        {
            RestClient client = GetClient();
            var parameters = new Parameters();
            parameters.Add("id", id);
            ...
            {
                User result =
                   await client.PostRequestObject<User>(FanfouConsts.BLOCKS_EXISTS, parameters);
                return true;
            }
            catch
            {
