    ...
    public sealed partial class InformationPage : Page
    {
        ...
        private void SendMessageButton_Click(object sender, RoutedEventArgs e)
        {
            Frame.Navigate(typeof(SendPage),
                ((int)SendPage.SendMode.ReplyUser).ToString()
                + Utils.DataConverter<FanfouAPI.Items.User>.Convert(
                    new FanfouAPI.Items.User() { id = "fanwp", screen_name = "饭窗" }));
        }

        private async void MarketButton_Click(object sender, RoutedEventArgs e)
        {
            await Launcher.LaunchUriAsync(new Uri("ms-windows-store:Review?PFN="));
        }
